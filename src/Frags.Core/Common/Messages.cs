...
namespace Frags.Core.Common
{
    public static class Messages
    {
        ...
        public static readonly string CHAR_MONEY_GIVEN = "{0} currency has been given to {1}.";
        public static readonly string CHAR_ACTIVE = "Character {0} activated successfully.";
