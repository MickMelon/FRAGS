...
{
    public class StatisticCharacterControllerTests
    {
        private readonly ITestOutputHelper output;

        public StatisticCharacterControllerTests(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        public async Task SetStatisticAsync_ValidInput_ReturnSuccess()
        {
            ...
            var controller = new StatisticCharacterController(charProvider, statProvider, new GenericProgressionStrategy(statProvider, statOptions, campProvider), campProvider);
